...
func setupRuntime(dir string) string {
  ...
  os.Setenv("RJ_DYLD_LIBRARY_PATH", os.Getenv("DYLD_LIBRARY_PATH"))
  os.Setenv("RJ_TERMINFO", os.Getenv("TERMINFO"))
  os.Setenv("RJ_SSL_CERT_DIR", os.Getenv("SSL_CERT_DIR"))
  os.Setenv("RJ_SSL_CERT_FILE", os.Getenv("SSL_CERT_FILE"))
  os.Setenv("RJ_RUBYOPT", os.Getenv("RUBYOPT"))
  os.Setenv("RJ_RUBYLIB", os.Getenv("RUBYLIB"))
  os.Setenv("RJ_GEM_HOME", os.Getenv("GEM_HOME"))
  os.Setenv("RJ_GEM_PATH", os.Getenv("GEM_PATH"))
